...
public class currencyconverter extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        txtFrom.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "USD", "EUR", "INR", "BD TK", " " }));
        ...
        txtTo.setModel(new javax.swing.DefaultComboBoxModel<>(new String[] { "USD", "EUR", "INR", "BD TK", " " }));
...
else if(txtFrom.getSelectedItem().toString()=="INR" && txtTo.getSelectedItem().toString()=="BD TK"){
    convert = amount * 1.30;
    JOptionPane.showMessageDialog(this,"The amount is: "+convert.toString()+"BD TK");
}
...
else if(txtFrom.getSelectedItem().toString()=="BD TK" && txtTo.getSelectedItem().toString()=="INR"){
    convert = amount * 0.77;
    JOptionPane.showMessageDialog(this,"The amount is: "+convert.toString()+"INR");
}
else {
